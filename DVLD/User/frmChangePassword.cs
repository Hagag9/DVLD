...
namespace DVLD.User
{
    public partial class frmChangePassword : Form
    {
        ...
        private void txtConfirmPassword_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                e.Cancel = true;
                errorProvider1.SetError(txtConfirmPassword, "Password Confirmation dose not match New Password");
            }
            else 
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("ome fileds are not valide!, put the mouse over the red icon(s) to see the erro",

...
namespace DVLD_DataAccess
{
	...
	{
		private static readonly SqlConnection connection = new SqlConnection(clsDataAccsessSetting.connectionString);
			...
			DateTime LastStatusDate,float PaidFees,int CreatedByUserID)
		{
			...
			catch { EventLog.WriteEntry(clsDataAccsessSetting.SourceName, ex.Message, EventLogEntryType.Error); }
